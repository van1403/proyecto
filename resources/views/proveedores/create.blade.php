...
<head>
    ...
    <title>Registrar Proveedor - Sistema de Inventarios</title>
    <style>
        :root {
...
<body>
                ...
                <form action="{{ route('proveedores.store') }}" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="nombre" name="nombre" required placeholder="Nombre de la empresa proveedora">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="producto" name="producto" required placeholder="Producto o servicio que ofrece">
                    </div>
                    
                    <div class="form-group">
                        <label for="direccion">Dirección</label>
                        <textarea id="direccion" name="direccion" rows="4" placeholder="Dirección de la empresa"></textarea>
                    </div>
    ...
    <footer>
        <div class="container">
            <p>Sistema de Inventarios &copy; 2025 - Registrar Proveedor</p>
        </div>
    </footer>
</body>
</html>