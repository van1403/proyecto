...
<head>
    ...
    <title>Registrar Cliente - Sistema de Inventarios</title>
    <style>
        :root {
...
<body>
    ...
    <main>
        <div class="container">
            <h2 class="section-title">Registrar Nuevo Cliente</h2>
            ...
            <div class="card">
                ...
                <form action="{{ route('clientes.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="direccion" name="direccion" rows="4" placeholder="Dirección completa"></textarea>
                    </div>
    ...
    <footer>
        <div class="container">
            <p>Sistema de Inventarios &copy; 2025 - Registrar Cliente</p>
        </div>
    </footer>
</body>
</html>