...
<head>
    ...
    <title>Agregar Producto - Sistema de Inventarios</title>
    <style>
        :root {
...
<body>
                ...
                <form action="{{ route('productos.store') }}" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" id="precio" name="precio" required min="0" step="0.01" placeholder="Precio del producto">
                        </div>
                        
                        <div class="form-group">
                            <label for="stock">Stock</label>
                            <input type="number" id="stock" name="stock" required min="0" placeholder="Cantidad en stock">
                        </div>
                    </div>
    ...
    <footer>
        <div class="container">
            <p>Sistema de Inventarios &copy; 2025 - Agregar Producto</p>
        </div>
    </footer>
</body>
</html>